...
\begin{itemize}
\item[]\textbf{Indata} Ändra import datalager as data till import daniel_data as data i filen data_test.py. Skriv \texttt{./data\_test.py} i terminalen.
\item[]\textbf{Resultat} 
\end{itemize}
...
\begin{itemize}
\item[]\textbf{Indata} cd till \texttt{/tdp003/Documents}. chmod check\_if\_english.py om det behövs för att göra den exekverbar. Kör programmet: \texttt{./check_if_eng.py wordlist_eng.txt ../portfolio_app/} Skriv ut innehållet för alla filer med \texttt{cat uword_directory/*} och kontrollera att de okända orden endast kan vara programmeringstermer.
\item[]\textbf{Resultat} 
\end{itemize}
