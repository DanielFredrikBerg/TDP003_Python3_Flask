...
\begin{itemize}
\item[]\textbf{Indata} Lägg till ett projekt och ett till sökfält på ett projekt i din JSON fil. Se Appendix B. Testa sedan att köra hemsidan med flask run. Sök på projekten i /list i de nya sökfält som lagts till.  
\item[]\textbf{Resultat} 
\end{itemize}
