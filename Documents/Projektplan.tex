...
%Ni saknar figurtexter till tabeller och då även referenser till dem också. Tack vare er layout är det relativt tydligt vad som tillhör och refererar till tabeller, men bättre att göra definitiva referenser.



%Formaterat referenser så de skriver ut rätt tabell, men referenserna pekar mot Tabellens label, inte tabellens top.. //Daniel

%Vad sägs om att färgkoda tiderna vi gissar det ska ta vs tiderna det verkligen tog? Lagt ett exempel för vecka 40. Behöver inte vara röd och grön. //Daniel
...
\begin{tabularx}{\linewidth}{|l|l|X|l|l|l|l|}
  ...
  \hline                                                      
                 & Hård deadline & \makecell[tl]{Korrigera Brister: \\Projektplanen}                                                  & 0-2 tim        & 3 tim 6 min ht & God      & 2\\
        \hline
