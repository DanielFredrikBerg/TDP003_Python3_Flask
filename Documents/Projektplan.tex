...
%Fixed -Jens% FRÅGA I MEJL OM DET ÄR OK ATT LÅTA SOM VI REDAN GJORT SAKER UTAN ATT FAKTISKT HA GJORT DET (PASSIV FORM). Undvik att skriva projektplanen i "vi"-form. Det ska vara ett passivt dokument. Även undvika ord som "rusha" då det inte riktigt passar i sådana dokument.
...
%Kan inte formatera referenser så att det syns i det kompilerade dokumentet. //Daniel
...
\end{tabularx}
\caption{Projektplanens Revisionshistorik}
\label{table:1}
\end{table}
...
\begin{tabularx}{\linewidth}{|l|l|X|l|l|l|l|}
  ...
  \hline
\end{tabularx}
\caption{Tabell över deadlines V.37}
\label{table:2}
\end{table}

Tidsåtgången för planeringsdokumentet utgjordes av 7 timmar \ref{table:2}. Av dessa ägnades:
\begin{itemize}
  \item Tisdag 8/9:
  \begin{itemize}
...
\begin{tabularx}{\linewidth}{|l|l|l|l|l|l|l|}
  ...
  \hline
\end{tabularx}
  \caption{Tabell över deadlines V.38}
  \label{tabell:3}
  \end{table}

Den Grundläggande installationsmanualen färdigställdes på 9 tim och 5 min \ref{table:3}:
\begin{itemize}
  \item Måndag 14/9:
  \begin{itemize}
...
Lofi-prototypen färdigställdes på 12 tim och 29 min \ref{table:3}:
\begin{itemize}
  \item Tisdag 15/9:
  \begin{itemize}
...
Egna insatser 1:a Versionen Gemensam installationsmanual färdigställdes på 9 timmar och 40 minuter \ref{table:4}:
\begin{itemize}
  \item Måndag 21/9:
  \begin{itemize}
...
\end{itemize}
  ...
  Projektplan 1:a utkast färdigställdes på 20 timmar 30 minuter \ref{table:4}:
\begin{itemize}
  \item Torsdag 17/9:
  \begin{itemize}
...
Bidra med icke-trivial förbättring - installationsmanual \ref{table:4}
\begin{itemize}
\item Tisdag 22/9:
  \begin{itemize}
...
Datalagret Godkänt\ref{table:5}
\begin{itemize}
...
Korrigera brister: Projektplanen \ref{table:5}
\begin{itemize}
...
Presentationslagret \ref{table:6}
\begin{itemize}
...
1:a Versionen Systemdokumentation \ref{table:7}
\begin{itemize}
...
Portfolion Publicerad \ref{table:7}
\begin{itemize}
...
\begin{tabularx}{\linewidth}{|l|l|X|l|l|l|l|}
  ...
  \hline
\end{tabularx}
      \caption{Tabell över deadlines V.43}
      \label{table:8}
      \end{table}

Testdokumentation inlämnad \ref{table:8}
\begin{itemize}
...
Individuellt Reflektionsblad \ref{table:8}
\begin{itemize}
...
\end{itemize}
  ...
  Korrigerat eventuella brister i systemdokumentationen. \ref{table:8}
\begin{itemize}
  \item 0-4 tim Potentiell brister rättades till.
\end{itemize}
